...
get_filters_for_combokey <- function(leaids) {
  ...
  for (i in x) {
    crdc_join_for_filters <-
      crdc_join_for_filters |>
      mutate(na_if_right = case_when(str_detect(as.character(COMBOKEY), paste0("^", as.character(leaids[i]))) ~ NA))
  }
  
  crdc_join_for_filters <-
    crdc_join_for_filters |>
    filter(is.na(na_if_right))
  return(crdc_join_for_filters)
}
...
create_plot <- function(county){
  ...
  crdc_join_county <- get_filters_for_combokey(county_leaids)
  ...
  county_pct_join |>
    ...
    coord_flip() +
    theme_minimal() +
    labs(title = paste("Percent of Students Mechanically Restrained", get_county_name(county), "2021-2022"),
         x = "Race",
...
unique(schl_loc$LEAID)

crdc_join_woc <-
  crdc_join |>
  filter(str_detect(as.character(COMBOKEY), "^2500001")|
         str_detect(as.character(COMBOKEY), "^2500002")|
         str_detect(as.character(COMBOKEY), "^2500036")|
         str_detect(as.character(COMBOKEY), "^2500045")|
         str_detect(as.character(COMBOKEY), "^2500051")|
         str_detect(as.character(COMBOKEY), "^2500073")|
         str_detect(as.character(COMBOKEY), "^2500587")|
         str_detect(as.character(COMBOKEY), "^2502040")|
         str_detect(as.character(COMBOKEY), "^2502160")|
         str_detect(as.character(COMBOKEY), "^2502220")|
         str_detect(as.character(COMBOKEY), "^2502580")|
         str_detect(as.character(COMBOKEY), "^2502710")|
         str_detect(as.character(COMBOKEY), "^2502715")|
         str_detect(as.character(COMBOKEY), "^2503120")|
         str_detect(as.character(COMBOKEY), "^2503750")|
         str_detect(as.character(COMBOKEY), "^2504230")|
         str_detect(as.character(COMBOKEY), "^2504360")|
         str_detect(as.character(COMBOKEY), "^2504890")|
         str_detect(as.character(COMBOKEY), "^2505130")|
         str_detect(as.character(COMBOKEY), "^2505370")|
         str_detect(as.character(COMBOKEY), "^2505880")|
         str_detect(as.character(COMBOKEY), "^2506300")|
         str_detect(as.character(COMBOKEY), "^2506720")|
         str_detect(as.character(COMBOKEY), "^2506780")|
         str_detect(as.character(COMBOKEY), "^2507080")|
         str_detect(as.character(COMBOKEY), "^2507680")|
         str_detect(as.character(COMBOKEY), "^2507860")|
         str_detect(as.character(COMBOKEY), "^2507890")|
         str_detect(as.character(COMBOKEY), "^2508050")|
         str_detect(as.character(COMBOKEY), "^2508280")|
         str_detect(as.character(COMBOKEY), "^2508310")|
         str_detect(as.character(COMBOKEY), "^2508760")|
         str_detect(as.character(COMBOKEY), "^2508880")|
         str_detect(as.character(COMBOKEY), "^2508910")|
         str_detect(as.character(COMBOKEY), "^2508940")|
         str_detect(as.character(COMBOKEY), "^2509540")|
         str_detect(as.character(COMBOKEY), "^2510770")|
         str_detect(as.character(COMBOKEY), "^2510980")|
         str_detect(as.character(COMBOKEY), "^2511010")|
         str_detect(as.character(COMBOKEY), "^2511050")|
         str_detect(as.character(COMBOKEY), "^2511150")|
         str_detect(as.character(COMBOKEY), "^2511310")|
         str_detect(as.character(COMBOKEY), "^2511400")|
         str_detect(as.character(COMBOKEY), "^2511490")|
         str_detect(as.character(COMBOKEY), "^2511850")|
         str_detect(as.character(COMBOKEY), "^2511880")|
         str_detect(as.character(COMBOKEY), "^2512100")|
         str_detect(as.character(COMBOKEY), "^2512240")|
         str_detect(as.character(COMBOKEY), "^2512390")|
         str_detect(as.character(COMBOKEY), "^2512600")|
         str_detect(as.character(COMBOKEY), "^2513080")|
         str_detect(as.character(COMBOKEY), "^2513230"))
...
woc_pct_join <-
  left_join(woc_tot_enr_calc, woc_tot_rst_calc, by = c("RACE_RST_CHR", "SEX_RST")) |>
  pivot_longer(cols = tot_hi_m:tot_tr_f,
               names_to = "RACE_SEX_ENR",
               values_to = "RACE_ENR") |>
  mutate(RACE_SEX_ENR = str_to_upper(RACE_SEX_ENR)) |>
  mutate(pct_rst = case_when(str_ends(RACE_SEX_ENR, paste0("_", RACE_RST, "_", SEX_RST)) ~
                     (tot_racesex_rst/RACE_ENR)*100,
                   TRUE ~ NA)) |>
  filter(!is.na(pct_rst))
...
woc_pct_join |>  
  ...
  coord_flip() +
  theme_minimal() +
  labs(title = paste("Percent of Students Mechanically Restrained", get_county_name(25027), "2021-2022"),
       x = "Race",
       y = "Percent Mechanically Restrained",
       fill = "Gender")
...
county <- c(06001) #County codes should be 4-5-digits. The first two digits represent the state FIPS code and the second three represent the county FIPS code. You can run a Google search to look up the FIPS code for any county in the U.S. 
